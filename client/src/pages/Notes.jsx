...
const Notes = () => {
  ...
  return (
    <div className='flex flex-col bg-white p-9 my-9 w-4/5 rounded-xl h-max shadow-2xl'>
        ...
        <p className='text-xl text-gray-600'>Access the extensive catalog of handwritten study notes shared by students htmlFor the current B.Tech curriculum.</p>
        ...
        <div className='flex justify-center gap-4'>
            ...
            <div className='w-full'>
                <label htmlFor="subject" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select the Subject</label>
